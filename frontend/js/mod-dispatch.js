    ...
    function transporterForm(t) {
      ...
      const body = h("div", {}, [
        h("div", { class: "form-grid" }, [
          ...
          U.field("Base Rate (₹)", `<input class="input" id="t_rate" type="number" value="${esc(f("baseRate", 0))}">`),
          U.field("On-Time %", `<input class="input" id="t_ot" type="number" min="0" max="100" value="${esc(f("onTime", 0))}">`),
